 ...
 * de caracteres u operacoones de sustituciones.
 */

const text = document.getElementById('text').textContent//este es el elemento

//cosntruyo la  primera expresion regular
const regEx = /lorem/gi //la expresion que esta en regex
